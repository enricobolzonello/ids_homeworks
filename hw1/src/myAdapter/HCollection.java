...
public interface HCollection {
    /** 
    *Returns the number of elements in this collection. If this collection contains more than <code>Integer.MAX_VALUE</code> elements, returns <code>Integer.MAX_VALUE</code>.
    ...
    */
    ...
    /**
     * Returns true if this collection contains the specified element. More formally, returns true if and only if this collection contains at least one element e such that <code>(o==null ? e==null : o.equals(e))</code>.
     ...
     * <code>String[] x = (String[]) v.toArray(new String[0]);</code>
    ...
    /**
     * Removes a single instance of the specified element from this collection, if it is present. More formally, removes an element e such that <code>(o==null ? e==null : o.equals(e))</code>, if this collection contains one or more such elements. Returns true if this collection contained the specified element (or equivalently, if this collection changed as a result of the call).
     * @param o element to be removed from this collection, if present
     * @return trueunexpected text if this collection changed as a result of the call
     * @throws NullPointerException if the specified element is null
     */
     ...
     * @throws NullPointerExcpetion if the specified collection contains one or more null elements
     */
